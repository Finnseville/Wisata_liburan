...
<div id="destinasi" class="container my-5">
  <h2 class="mb-4 text-center fw-bold">Paket Wisata Menjelajah</h2>

  <div class="row g-4 justify-content-center">

<!-- Paket komodo -->
<div class="col-md-4">
  <a href="example.php" class="text-decoration-none text-dark">
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">

      <!-- Image wrapper -->
      <div class="position-relative">
        <img
          src="../src/paket2/komodo.jpg"
          class="w-100"
          alt="Pantai Kelor"
...
<div class="col-md-4">
  <a href="#" class="text-decoration-none text-dark">
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
      ...
      <div class="position-relative">
        <img
          src="../src/paket2/pulau-komodo.jpg"
          class="w-100"
          alt="Pantai Kelor"
          style="height:260px; object-fit:cover;"
        >
...
<div class="col-md-4">
  <a href="#" class="text-decoration-none text-dark">
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
      ...
      <div class="position-relative">
        <img
          src="../src/paket2/pulau-sebayur.jpg"
          class="w-100"
          alt="Pantai Kelor"
          style="height:260px; object-fit:cover;"
        >
