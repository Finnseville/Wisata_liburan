...
<!-- LEFT CONTENT -->
    <div class="col-lg-8">
      ...
      <h1 class="fw-bold">Paket Pantai kelor dan Pantai pink</h1>
      <p class="text-muted">
        Ingin menjelajahi pantai kelor dan pantai pink? Langsung saja segara<br>
        pesan Paket Pantai pink dan Pantai pink yang kami sediakan!.
      </p>
      
       <h1 class="fw-bold mt-5">Mengapa Paket kelor dan Pantai pink?</h1>
      <p class="text-muted">
      ...
      <!-- Day 1 -->
      <h1 class="fw-bold mt-5">Itinerary Paket kelor dan Pantai pink</h1>
      <h2 class="fw-bold mt-2">Day 1 - Night 1, Pantai kelor</h2>
      <ul>
        <li>Penjemputan di hotel Labuan Bajo oleh tim pengantar NaTour.</li>
        <li>Berangkat ke Pantai kelor (Perkiraan 2-3 Jam)</li>
        <li>Makan siang di Restoran Lokal</li>
        <li>Aktivitas Day - 1 Pantai kelor :</li>
          <ul>
      ...
      <!-- Day 2 -->
      <h1 class="fw-bold mt-5">Itinerary Paket kelor dan Pantai pink</h1>
      <h2 class="fw-bold mt-2">Day 2 - Night 2, Pantai pink</h2>
      <ul>
        <li>Penjemputan di Guest-House Pantai kelor oleh tim pengantar NaTour.</li>
      ...
      <img src="../src/paket1/paintaipink.jpg"
           class="img-fluid rounded-3 shadow-sm my-3"
           alt="ricaa">
