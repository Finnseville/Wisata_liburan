...
<!-- LEFT CONTENT -->
    <div class="col-lg-8">
      ...
      <h1 class="fw-bold">Paket Pantai Sebayur dan Pantai Pink</h1>
      <p class="text-muted">
        Ingin menjelajahi pantai sebayur dan pantai pink? Langsung saja segara<br>
        pesan Paket Pantai Kelor dan Pantai pink yang kami sediakan!.
      </p>
      
       <h1 class="fw-bold mt-5">Mengapa Paket Sebayur dan Pantai Pink?</h1>
      <p class="text-muted">
