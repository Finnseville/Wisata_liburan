...
<!-- LEFT CONTENT -->
    <div class="col-lg-8">
      ...
      <h1 class="fw-bold">Paket Tour Menjelajah NTT</h1>
      <p class="text-muted">
        Ingin menjelajahi Pulau komodo, Pulau Serbayu dan pulau rinca? Langsung saja segara <br>
        pesan Paket Komodo yang kami sediakan!.
      </p>
      
       <h1 class="fw-bold mt-5">Mengapa Paket Tour Menjelajah NTT?</h1>
      <p class="text-muted">
        Paket ini memungkinkan anda menjelajahi 3 pulau dalam 3 hari, Pulau rinca, Pulau Serbayu <br>
      ...
      <!-- Day 1 -->
      <h1 class="fw-bold mt-5">Itinerary Paket Tour Menjelajah NTT</h1>
      <h2 class="fw-bold mt-2">Day 2 - Night 2, Pulau Komodo</h2>
      <ul>
      ...
      <!-- Day 3 -->
      <h1 class="fw-bold mt-5">Itinerary Paket Tour Menjelajah NTT</h1>
      <h2 class="fw-bold mt-2">Day 3 - Night 3, Pulau Rinca</h2>
      <ul>
