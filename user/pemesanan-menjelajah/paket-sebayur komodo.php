...
<div class="container my-5">
  <div class="row g-4">
    ...
    <div class="col-lg-8">
      ...
      <p class="text-muted">
        Ingin menjelajahi Pulau Komodo dan Pulau Sebayur?
        Paket ini dirancang untuk anda yang ingin merasakan
        petualangan alam, trekking, dan panorama laut NTT.
      </p>

      <h2 class="fw-bold mt-5">Mengapa Memilih Paket Ini?</h2>
      <p class="text-muted">
        Paket Sebayur Komodo memungkinkan anda mengunjungi
        dua pulau ikonik dalam dua hari. Anda akan trekking
        bersama ranger, melihat Komodo secara langsung,
        dan menikmati laut Sebayur yang jernih.
      </p>
