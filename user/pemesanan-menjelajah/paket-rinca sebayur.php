...
<div class="container my-5">
 ...
 <!-- LEFT CONTENT -->
    <div class="col-lg-8">
      ...
      <h1 class="fw-bold">Paket Rinca Sebayur</h1>
      <p class="text-muted">
        Ingin menjelajahi Pulau Sbayur dan pulau rinca? Langsung saja segara<br>
        pesan Paket Rinca Sebayur yang kami sediakan!.
      </p>

       <h1 class="fw-bold mt-5">Mengapa Paket Rinca Sebayur?</h1>
      <p class="text-muted">
        Paket ini memungkinkan anda menjelajahi 2 pulau dalam 2 hari, Pulau rinca<br>dan pulau Sebayur, Trekking dan melihat komodo dengan paket ini.<br>hanya dengan sekali ketukan anda bisa menikmati nya sekarang juga!
      </p>

      <!-- Day 1 -->
      <h1 class="fw-bold mt-5">Itinerary Paket Rinca Sebayur</h1>
      <h2 class="fw-bold mt-2">Day 1 - Night 1, Pulau Sebayur</h2>
      <ul>
        <li>Penjemputan di hotel Labuan Bajo oleh tim pengantar NaTour.</li>
        <li>Berangkat ke Pulau Sebayur (Perkiraan 2-3 Jam)</li>
        <li>Makan siang di Restoran Lokal</li>
        <li>Aktivitas Day - 1 Pulau Sebayur :</li>
          <ul>
      ...
      <img src="../src/paket2/pulau-sebayur.jpg"
           class="img-fluid rounded-3 shadow-sm my-3"
           alt="yuri">

      <!-- Day 2 -->
      <h1 class="fw-bold mt-5">Itinerary Paket Rinca Sebayur</h1>
      <h2 class="fw-bold mt-2">Day 2 - Night 2, Pulau Rinca</h2>
      <ul>
      ...
      <div class="alert alert-warning rounded-4 mt-4">
        ...
        <ul class="mb-0">
          ...
          <li>Jadwal dapat berubah karena cuaca</li>
        </ul>
      </div>
